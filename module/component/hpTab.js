  ...
  var hp_tab = {
    ...
    tabAdd: function(id, title, href) {
      ...
      element.tabAdd('hp-tab-filter', {
        title: title,
        content: '<iframe class="hp-iframe" style="width:100%"  src="' + href + '" id= iframe'+id+'/>',
    ...
    tabDelete: function(othis) {
      //删除指定Tab项
      element.tabDelete('hp-tab-filter', id);
    ...
    winResize: function() {
      $(window).on('resize', function() {
        ...
        $('.layui-tab-content iframe').height(currBoxHeight-30);
      }).resize();
    }
